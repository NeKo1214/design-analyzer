...
${isMulti ? `
| 评估维度 | 图1 得分（/10） | 图1 一句话判决 | 图2 得分（/10） | 图2 一句话判决 |
|----------|----------------|----------------|----------------|----------------|
| 信息架构 | ? | | ? | |
| 视觉层次 | ? | | ? | |
| 交互合理性 | ? | | ? | |
...
## ${n(1)}、功能优先级矩阵
${isMulti ? `
| 图示 | 功能点 | Kano 类型 | 用户价值 | 实现成本 | 优先级判断 |
|------|--------|----------|---------|---------|-----------|
| 图1 | ? | 必备/期望/魅力 | 高/中/低 | 高/中/低 | |
| 图2 | ? | 必备/期望/魅力 | 高/中/低 | 高/中/低 | |` : `
...
## ${n(2)}、设计系统一致性审计
${isMulti ? `
| 检查项 | 图1 状态 | 图1 问题描述 | 图2 状态 | 图2 问题描述 |
|--------|---------|------------|---------|------------|
| 字体层级 | ✅/⚠️/❌ | | ✅/⚠️/❌ | |
| 色彩体系 | ✅/⚠️/❌ | | ✅/⚠️/❌ | |
| 间距规律 | ✅/⚠️/❌ | | ✅/⚠️/❌ | |
